...
In the FHIR profile for CareCommunication medcom-messaging-organization, it is required that both the SOR ID and the location number are specified for the organization sending a CareCommunication.
This means:
