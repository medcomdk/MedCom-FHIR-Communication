...
### 1.0.1 Scenario #1 - Normally successful unsolicited message or request message flow with acknowledgement request (Google translated)
...
### 1.0.2 Scenario #2 - Duplicate an unchanged message with a positive acknowledgement request (Google translated)
...
### 1.0.3 Scenario #3 - (Re) Sending Unchanged Message (Google translated)
...
### 1.0.4 Scenario #4 - Message is sent normally, acknowledgement is lost along the way (Google translated)
...
### 1.0.5 Scenario #5 - (Re-) Sending Modified Message (Google translated)
